...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Accurate pluscode {?} coordinates: ".replace("?", "2V89+CR Amman") + getCoordinatesProcess.GetCoordinates("2V89+CR Amman"));
		System.out.println("In Between.....");
		System.out.println("InAccurate pluscode {?} coordinates: ".replace("?", "2V89+CR") + getCoordinatesProcess.GetCoordinates("2V89+CR"));
