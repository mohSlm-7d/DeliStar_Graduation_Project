...
import com.deli.star.processor.AddOrdersProcessor;
...
public class AdminOrdersService {
	...
	public String AddOrder(String addOrderRequest) {
		...
		try {
			...
			AddOrdersProcessor addOrderProcess = new AddOrdersProcessor();
	...
	public String DeleteOrder(String deleteOrderRequest) {
		...
		try {
			...
			if(!deleted) {
				if(requestingAdmin.getAdminToken().toString().equals(ResponseStatus.Failed.toString())) {
					response.put("status", ResponseStatus.Failed.toString());
